...
<div class="container py-5">
    ...
    <ul class="nav nav-tabs mb-4">
        ...
        <li class="nav-item">
            <a class="nav-link ui-state-disabled" href="#orders" data-bs-toggle="tab">
                ...
                <div class="col-md-4 mb-4">
                    <div class="card" style="color: white">
                        <div class="card-body text-center">
                            ...
                            <p class="text-secondary">Joined since ${joinDate}</p>
                ...
                <div class="col-md-8">
                    <div class="card">
                        <div class="card-body" style="color: white">
                            ...
                            <form action="updateProfileServlet" method="post" style="color: white">
                                <div class="row mb-3">
                                    <div class="col-md-6">
