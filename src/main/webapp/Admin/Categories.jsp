                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table">
                            ...
                            <tr>
                                <td>1</td>
                                <td>Men's Dark Washed</td>
                                <td>
                                    Dark Washed Jeans that are specifically made for men
                                </td>
                            ...
                            <tr>
                                <td>2</td>
                                <td>Women's Dark Washed</td>
                                <td>
                                    Dark Wash Jeans that are specifically made for women
                                </td>
                                <td><span class="badge bg-success">Active</span></td>
                                <td>
                                    <button class="btn btn-sm btn-info me-2">
